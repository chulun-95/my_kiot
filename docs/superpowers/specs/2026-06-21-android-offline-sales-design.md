...
| 5 | Kích hoạt sync | **Nút "Đồng bộ ngay" thủ công** (luôn hiển thị số đơn chưa sync) là cơ chế chính. **Bổ sung**: tự đẩy ngầm khi đang online (sau mỗi đơn / khi mở app) để online không bị ùn — *cần xác nhận lại với chủ dự án*. |
...
## 8. Câu hỏi mở cần chốt khi review
- Có bật **tự đẩy ngầm khi online** không (mục 1.5 / AND-6)? (Yêu cầu gốc nói "định kỳ", lựa chọn lại chỉ chọn nút thủ công.)
- `/reports/offline-negative` làm màn riêng hay gộp vào cảnh báo tồn hiện có?
